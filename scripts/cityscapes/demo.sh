...
LVD_TAG="2022-05-16-12:10:29-train_lvd_cityscapes"
FLP_TAG="2022-05-17-10:46:43-train_flp_cityscapes"
WIF_TAG="2022-05-18-18:39:55-train_wif_cityscapes"
GPU_IDS="0"
NUM_GPUS=1
NUM_NODES=1
...
CUDA_VISIBLE_DEVICES=${GPU_IDS} python -m ${TORCHRUN} helpers/synthesizer_evaluator.py \
 --name demo_cityscapes --datetime ${DATETIME} --gpu_ids ${GPU_IDS} --dataroot "datasets/demo_cityscapes" \
 --dataset "cityscapes" --dim 128 --load_dim 512 --true_dim 512 --flow_dim 128 --vid_len 14 --num_workers 8 --num_workers_eval 1 \
 ...
 --s_loop_ii --s_inpaint_obj --s_propagate_unique --s_use_shadows --s_use_expansion \
 --s_soft_shadow --s_propagate_obj --s_use_inpainter --s_use_mat_inpainter --s_inpainter_path "checkpoints/mat/Places_512_FullData.pkl"
