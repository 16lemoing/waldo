...
CUDA_VISIBLE_DEVICES=${GPU_IDS} python -m ${TORCHRUN} helpers/synthesizer_trainer.py \
 --name train_flp_cityscapes --datetime ${DATETIME} --gpu_ids ${GPU_IDS} \
 ...
 --s_patch_size 16 --s_latent_shape 8 16 --s_embed_dim 512 --s_num_obj 16 \
 --s_use_pe --s_use_pg --s_oe_num_timesteps 5 --s_pg_num_timesteps 14 --s_lambda_rec_occ_score 0.1 \
