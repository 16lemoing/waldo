...
LVD_TAG="2022-05-16-12:13:05-train_lvd_kitti"
FLP_TAG="2022-05-18-07:57:54-train_flp_kitti"
WIF_TAG="2022-05-18-08:07:27-train_wif_kitti"
GPU_IDS="0"
NUM_GPUS=1
NUM_NODES=1
...
CUDA_VISIBLE_DEVICES=${GPU_IDS} python -m ${TORCHRUN} helpers/synthesizer_evaluator.py \
 --name demo_kitti --datetime ${DATETIME} --gpu_ids ${GPU_IDS} --dataroot "datasets/demo_kitti" \
