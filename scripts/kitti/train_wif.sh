...
CUDA_VISIBLE_DEVICES=${GPU_IDS} python -m ${TORCHRUN} helpers/synthesizer_trainer.py \
 --name train_wif_kitti --datetime ${DATETIME} --gpu_ids ${GPU_IDS} \
 --dataset "kitti" --load_all --dim 128 --load_dim 256 --true_dim 256 --flow_dim 128 --vid_len 5 --load_vid_len 14 --load_n_plus_1 --num_workers 8 --num_workers_eval 1 --shuffle_valid \
