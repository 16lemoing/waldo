...
CUDA_VISIBLE_DEVICES=${GPU_IDS} python -m ${TORCHRUN} helpers/synthesizer_trainer.py \
 --name train_flp_kitti --datetime ${DATETIME} --gpu_ids ${GPU_IDS} \
 --dataset "kitti" --load_all --dim 128 --true_dim 128 --vid_len 10 --num_workers 16 --shuffle_valid \
 --num_iter 1000000 --num_iter_eval 10000 --save_latest_freq 1000 --log_freq 10000 \
 --s_patch_size 16 --s_latent_shape 8 26 --s_embed_dim 512 --s_num_obj 16 \
 --s_use_pe --s_use_pg --s_oe_num_timesteps 5 --s_pg_num_timesteps 10 --s_lambda_rec_occ_score 0.1 \
 --vid_modes 'vid_pose_generator' --s_vid_pose_generator_losses "rec_obj_pose" "rec_bg_pose" "rec_occ_score" \
 --batch_size_vid 4 --s_blur_pxl --s_blur_sigma 2.0 \
 ...
 --s_ctx_mode "prev" --s_bg_mul 1.2 \
 --s_min_ctx_length_vid 4 --s_max_ctx_length_vid 4 --s_unconstrained_pose_decoder --s_lambda_rec_occ_score 0.01 \
 --s_edge_size 15 --s_flow_thresh 0.02 \
 --s_use_last_pose_decoder --s_bg_mul_pose_decoder 1.2 \
 --max_batch_eval_vid 32 --vid_metric "loss" --s_input_rgb "False"